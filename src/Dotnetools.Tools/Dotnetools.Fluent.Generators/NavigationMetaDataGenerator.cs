...
namespace Dotnetools.Fluent.Generators;

[Generator]
public class NavigationMetaDataGenerator : ISourceGenerator
{
	private const string NavigationMetaDataAttributeDisplayString = "Dotnetools.Fluent.NavigationMetaDataAttribute";

	private const string NavigationMetaDataDisplayString = "Dotnetools.Fluent.NavigationMetaData";

	private const string RoutableViewModelDisplayString = "Dotnetools.Fluent.ViewModels.Navigation.RoutableViewModel";
