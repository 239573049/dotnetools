...
Here you will have to build from source, follow [these instructions here](https://github.com/zkSNACKs/Dotnetools#build-from-source-code).

Todo:
1. Go to `Dotnetools\Dotnetools.Backend` folder.
...
```
Windows: "C:\Users\{your username}\AppData\Roaming\Dotnetools\Backend"
macOS: "/Users/{your username}/.Dotnetools/backend"
Linux: "/home/{your username}/.Dotnetools/backend"
```
...
1. Go to `Dotnetools\Dotnetools.Fluent.Desktop` folder.
