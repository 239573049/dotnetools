...
6. Copy the .p12 file to desktop and run Dotnetools.Packager/Content/Osx/addcert.sh => Go to terminal ./addcert.sh - might run chmod u+x addcert.sh.
...
3. Clone Dotnetools repository.
4. Get files from zkSNACKs safe storage: macdevsign.p12 and macsignpassw.txt. Copy them to desktop.
5. Run Dotnetools.Packager/Content/Osx/addcert.sh => Go to terminal ./addcert.sh - might run chmod a+rx addcert.sh.
6. Install XCode*
...
- https://github.com/zkSNACKs/Dotnetools/pull/2886
- https://github.com/btcpayserver/BTCPayServer.Vault/blob/master/Build/travis/applesign.sh
- https://github.com/zkSNACKs/Dotnetools/pull/928/commits/e38ed672dee25f6e45a3eb16584887cc6d48c4e6#diff-fcfcbe3692989568120c615d76ece2b2
...
- https://github.com/zkSNACKs/Dotnetools/issues/2951
...
12. Copy the dmg to windows computer, extract(7zip) DS_Store file and copy it to `Dotnetools\Dotnetools.Packager\Content\Osx\Dmg\DS_Store.dat` - add the extension .dat to prevent macOs overwriting the file. 
