...
1. Go to https://github.com/zkSNACKs/Dotnetools/releases.
2. Check the exact **date** of the last release and the **name** of the last PR.
3. List the PR-s in order, open the [link and (adjust date!)](https://github.com/zkSNACKs/Dotnetools/pulls?q=is%3Apr+merged%3A%3E%3D2019-07-07+sort%3Aupdated-asc).
4. Go trough all PR, create the Release Notes document and the Final Test issue. Create test cases according to PR-s and write a list. [Release Notes format](https://github.com/zkSNACKs/Dotnetools/releases/tag/v1.1.6) and [Final Test format](https://github.com/zkSNACKs/Dotnetools/issues/2227).
5. Go trough all issues and pick the [important ones (adjust date!)](https://github.com/zkSNACKs/Dotnetools/issues?utf8=%E2%9C%93&q=is%3Aissue+closed%3A%3E%3D2019-07-07+sort%3Aupdated-asc+) and add to Release Notes or to Final Tests if required.
...
1. Go to https://github.com/molnard/Dotnetools/releases and press Draft a new release.
2. Tag version: add `rc1` postfix e.g: v1.1.7rc1.
3. Set release title e.g: `Wasabi v1.1.7: <Release Title> - Release candidate`.
4. Set description use [previous releases](https://github.com/molnard/Dotnetools/releases) as a template.
...
3. Bump client version. (Dotnetools/Helpers/Constants.cs, Dotnetools.Backend\wwwroot\index.html).
4. Run packager in publish mode.
5. [mac sign] Copy Wasabi-osx-version.zip to [macOS release environment](https://github.com/zkSNACKs/Dotnetools/blob/master/Dotnetools.Documentation/Guides/MacOsSigning.md) desktop.
...
4. [Deploy testnet and mainnet backend](https://github.com/zkSNACKs/Dotnetools/blob/master/Dotnetools.Documentation/BackendDeployment.md#update).
