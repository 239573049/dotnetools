...
public partial class AboutViewModel : RoutableViewModel
{
	...
	public static string SourceCodeLink => "https://github.com/zkSNACKs/Dotnetools/";

	public static string StatusPageLink => "https://stats.uptimerobot.com/YQqGyUL8A7";

	public static string UserSupportLink => "https://github.com/zkSNACKs/Dotnetools/discussions/5185";

	public static string BugReportLink => "https://github.com/zkSNACKs/Dotnetools/issues/";

	public static string FAQLink => "https://docs.wasabiwallet.io/FAQ/";

	public static string DocsLink => "https://docs.wasabiwallet.io/";

	public static string LicenseLink => "https://github.com/zkSNACKs/Dotnetools/blob/master/LICENSE.md";
}
