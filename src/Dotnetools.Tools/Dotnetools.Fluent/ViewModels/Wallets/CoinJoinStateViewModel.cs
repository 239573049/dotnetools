...
using Dotnetools.Fluent.State;
using Dotnetools.Fluent.ViewModels.CoinJoinProfiles;
...
using Dotnetools.WabiSabi.Client.StatusChangedEvents;
	...
	public CoinJoinStateViewModel(WalletViewModel walletVm)
	{
		...
		walletVm.Settings.WhenAnyValue(x => x.PlebStopThreshold)
			.SubscribeAsync(async _ =>
			{
				...
				// https://github.com/molnard/Dotnetools/blob/master/Dotnetools.Fluent/ViewModels/Wallets/WalletSettingsViewModel.cs#L105
