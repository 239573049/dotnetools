...
using Dotnetools.Fluent.ViewModels.Wallets.Advanced;
using Dotnetools.Fluent.ViewModels.Wallets.Advanced.WalletCoins;
using Dotnetools.Fluent.ViewModels.Wallets.Home.History;
using Dotnetools.Fluent.ViewModels.Wallets.Home.Tiles;
using Dotnetools.Fluent.ViewModels.Wallets.Receive;
