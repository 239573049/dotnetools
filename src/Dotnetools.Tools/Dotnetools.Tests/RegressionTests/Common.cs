...
using Dotnetools.Tests.XunitConfiguration;
using Dotnetools.Wallets;
using Dotnetools.WebClients.Wasabi;
using Xunit;

namespace Dotnetools.Tests.RegressionTests;
...
public static class Common
{
		...
		[CallerMemberName] string callerMemberName = "")
	{
		...
		var serviceConfiguration = new ServiceConfiguration(regTestFixture.BackendRegTestNode.P2pEndPoint, Money.Coins(Dotnetools.Helpers.Constants.DefaultDustThreshold));
