...
using Dotnetools.Crypto.Groups;
...
namespace Dotnetools.Tests.UnitTests.WabiSabi.Models;
...
public class SerializationTests
{
	...
	{
		var round = WabiSabiFactory.CreateRound(new Dotnetools.WabiSabi.Backend.WabiSabiConfig());
