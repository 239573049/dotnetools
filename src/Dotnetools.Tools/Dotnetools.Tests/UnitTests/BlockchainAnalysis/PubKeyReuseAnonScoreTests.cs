using NBitcoin;
using System.Linq;
using Dotnetools.Blockchain.Analysis;
using Dotnetools.Blockchain.Keys;
using Dotnetools.Tests.Helpers;
using Xunit;

namespace Dotnetools.Tests.UnitTests.BlockchainAnalysis;
...
public class PubKeyReuseAnonScoreTests
{
	...
	public void OutputSideAddressReuseBySomeoneElse()
	{
		...
		// https://github.com/zkSNACKs/Dotnetools/pull/4724/commits/6f5893ca57e35eadb6e20f164bdf0696bb14eea1#r530847724
		var analyser = new BlockchainAnalyzer();
		var km = ServiceFactory.CreateKeyManager();
