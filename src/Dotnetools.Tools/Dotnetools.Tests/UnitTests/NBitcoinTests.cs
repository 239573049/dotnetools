...
public class NBitcoinTests
{
	...
	{
		Assert.Equal(Dotnetools.Helpers.Constants.DefaultMainNetBitcoinCoreRpcPort, Network.Main.RPCPort);
		Assert.Equal(Dotnetools.Helpers.Constants.DefaultTestNetBitcoinCoreRpcPort, Network.TestNet.RPCPort);
		Assert.Equal(Dotnetools.Helpers.Constants.DefaultRegTestBitcoinCoreRpcPort, Network.RegTest.RPCPort);
		Assert.Equal(Dotnetools.Helpers.Constants.DefaultMainNetBitcoinP2pPort, Network.Main.DefaultPort);
		Assert.Equal(Dotnetools.Helpers.Constants.DefaultTestNetBitcoinP2pPort, Network.TestNet.DefaultPort);
		Assert.Equal(Dotnetools.Helpers.Constants.DefaultRegTestBitcoinP2pPort, Network.RegTest.DefaultPort);
	}
