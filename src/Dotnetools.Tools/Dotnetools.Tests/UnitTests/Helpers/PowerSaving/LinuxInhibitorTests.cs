...
using Dotnetools.Helpers.PowerSaving;
using Dotnetools.Microservices;
using Xunit;
using static Dotnetools.Helpers.PowerSaving.LinuxInhibitorTask;

namespace Dotnetools.Tests.UnitTests.Helpers.PowerSaving;
