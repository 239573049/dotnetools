...
using System.IO;
using Dotnetools.Backend.Middlewares;
...
using Dotnetools.WebClients;

[assembly: ApiController]

namespace Dotnetools.Backend;
...
public class Startup
{
	...
	{
		string dataDir = Configuration["datadir"] ?? EnvironmentHelpers.GetDataDir(Path.Combine("Dotnetools", "Backend"));
		...
		services.AddSwaggerGen(c =>
		{
			c.SwaggerDoc(
				...
				new OpenApiInfo
				{
					...
					License = new OpenApiLicense { Name = "Use under MIT.", Url = new Uri("https://github.com/zkSNACKs/Dotnetools/blob/master/LICENSE.md") }
				});

			// Set the comments path for the Swagger JSON and UI.
			var basePath = AppContext.BaseDirectory;
			var xmlPath = Path.Combine(basePath, "Dotnetools.Backend.xml");
