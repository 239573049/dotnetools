...
using Dotnetools.CoinJoin.Coordinator;
using Dotnetools.CoinJoin.Coordinator.Rounds;
...
public class Global : IDisposable
{
	...
	{
		DataDir = dataDir ?? EnvironmentHelpers.GetDataDir(Path.Combine("Dotnetools", "Backend"));
		RpcClient = rpcClient;
		Config = config;
		HostedServices = new();
		HttpClient = new();
