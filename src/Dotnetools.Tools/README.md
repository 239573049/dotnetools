...
<h3 align="center">
  ...
  <span> | </span>
  <a href="https://github.com/zkSNACKs/Dotnetools/discussions/5185">
    Support
  </a>
  <span> | </span>
  ...
  <span> | </span>
  <a href="https://github.com/zkSNACKs/Dotnetools/blob/master/PGP.txt">
    PGP
  </a>
</div>
...
[7]: https://img.shields.io/github/license/zkSNACKs/Dotnetools.svg
[8]: https://github.com/zkSNACKs/Dotnetools/blob/master/LICENSE.md
[9]: https://www.codefactor.io/repository/github/zksnacks/Dotnetools/badge
[10]: https://www.codefactor.io/repository/github/zksnacks/Dotnetools
...
# [Download Wasabi](https://github.com/zkSNACKs/Dotnetools/releases)

<br>

![](https://raw.githubusercontent.com/zkSNACKs/Dotnetools/master/Dotnetools.Backend/wwwroot/img/screenshots/webpage_ui_compilation-02.png)
...
```sh
git clone --depth=1 --single-branch --branch=master https://github.com/zkSNACKs/Dotnetools.git
cd Dotnetools/Dotnetools.Fluent.Desktop
dotnet build
```

### Run Wasabi

Run Wasabi with `dotnet run` from the `Dotnetools.Fluent.Desktop` folder.
