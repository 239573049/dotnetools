...
using Dotnetools.Fluent.CrashReport;
using Dotnetools.Fluent.Helpers;
using Dotnetools.Fluent.ViewModels;
...
using LogLevel = Dotnetools.Logging.LogLevel;
using System.Diagnostics.CodeAnalysis;
using Dotnetools.Fluent.Desktop.Extensions;
using System.Net.Sockets;
using System.Collections.ObjectModel;

namespace Dotnetools.Fluent.Desktop;
...
public class Program
{
	...
	public static int Main(string[] args)
	{
		...
		string dataDir = EnvironmentHelpers.GetDataDir(Path.Combine("Dotnetools", "Client"));
