...
using Dotnetools.BitcoinCore.Configuration;
using Dotnetools.BitcoinCore.Configuration.Whitening;
using Dotnetools.BitcoinCore.Processes;
...
using Dotnetools.Microservices;
using Dotnetools.Userfacing;

namespace Dotnetools.BitcoinCore;
			...
			var desiredConfigLines = new List<string>()
				{
					...
					$"{configPrefix}.daemon			= 0", // https://github.com/zkSNACKs/Dotnetools/issues/3588
