...
using Dotnetools.CoinJoin.Common.Models;
using Dotnetools.CoinJoin.Coordinator.Banning;
using Dotnetools.CoinJoin.Coordinator.Participants;
...
public class Coordinator : IDisposable
{
	...
	public async Task ProcessConfirmedTransactionAsync(Transaction tx)
	{
		...
		// https://github.com/zkSNACKs/Dotnetools/issues/145
	...
	/// https://github.com/zkSNACKs/Dotnetools/issues/1155
	/// </summary>
