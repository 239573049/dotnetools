...
using Dotnetools.Hwi.Exceptions;
using Dotnetools.Hwi.Models;

namespace Dotnetools.Hwi.Parsers;
...
public static class HwiParser
{
	...
	public static Version ParseVersion(string hwiResponse)
	{
		...
		// Order matters! https://github.com/zkSNACKs/Dotnetools/pull/1905/commits/cecefcc50af140cc06cb93961cda86f9b21db11b
