...
cd $env:userprofile\desktop/Dotnetools/Dotnetools.Packager
dotnet run -- publish
...
$arguments = $env:userprofile + '\Desktop\Dotnetools\Dotnetools.WindowsInstaller\Dotnetools.WindowsInstaller.wixproj /Build "Release|x64"'
